...
```
            ...
            変数.処理ステータス <> 0  の場合、エラーメッセージを出力し処理終了
                           - エラーコード：'E.LDXXXXXX'
                           - エラーメッセージ：'Return  ' || 変数.処理ステータス || ','|| 変数.SQLコード || ','||  数.エラーコード || ','|| 変数.エラーメッセージ || ','|| 変数.エラー位置
...
###### 2.3.2.2.5.1.4.1.担当課、担当者、品目タイプ取得
...
###### 2.3.2.2.5.1.4.3.子品目の手持在庫変動ログ作成
