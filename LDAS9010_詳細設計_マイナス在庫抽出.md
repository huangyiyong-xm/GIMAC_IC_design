...
- 引数.SUサインが NULL または '1', '2', '3' 以外の場合
  ...
  - エラーコード：E.LDP11018
  - エラーメッセージ：Argument Error : [ps_su_sign] = 引数.SUサインの値
- 引数.A/Nサインが NULL または '1', '2', '3' 以外の場合

  - エラーコード：E.LDP11019
  - エラーメッセージ：Argument Error : [ps_act_sign] = 引数.A/Nサインの値
...
- A/Nサイン = '2' かつ オーダーサインが NULL または '1' 以外 の場合：次のレコードの処理へ移行する
- A/Nサイン = '3' かつ オーダーサイン = '1' の場合：次のレコードの処理へ移行する
