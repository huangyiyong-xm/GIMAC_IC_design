...
DECLARE
    ...
    ln_order_qty                          DECIMAL;
    ln_receipt_qty                        DECIMAL;
    ln_scrap_qty                          DECIMAL;
    ls_drd_item_type                      VARCHAR;
    ls_drd_comp_sign                      VARCHAR;
    ln_drd_comp_qty                       DECIMAL;
    ln_drd_comp_op_percent                DECIMAL;
    ls_drd_start_date                     VARCHAR;
    ls_drd_order_status                   VARCHAR;
    ln_drd_required_qty                   DECIMAL;
    ln_drd_ship_qty                       DECIMAL;
    ls_drd_forecast_item_type             VARCHAR;
    ls_drd_forecast_comp_sign             VARCHAR;
    ln_drd_forecast_comp_qty              DECIMAL;
    ln_drd_forecast_comp_op_percent       DECIMAL;
    ls_drd_forecast_start_date            VARCHAR;
    ls_drd_forecast_order_status          VARCHAR;
    ln_drd_forecast_required_qty          DECIMAL;
    ln_drd_forecast_ship_qty              DECIMAL;
    ln_add_cnt1                           INTEGER;
    ln_add_cnt2                           INTEGER;
    ln_del_cnt1                           INTEGER;
    ln_del_cnt2                           INTEGER;
