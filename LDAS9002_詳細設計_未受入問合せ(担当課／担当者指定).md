...
PYMAC部門コード指定のオーダー明細と独立所要量明細の未受入問合せを返す。
...
| 6   | 社内／社外区分   | ps_org_category  | VARCHAR | 1:ALL2:社内3:社外 |
...
| 20  | MRP更新日        | rs_mrp_date       | VARCHAR |                                                    |
| 21  | OD/RDフラグ      | rs_flag           | VARCHAR | 0：独立所要量、"1"：オーダー                       |
| 22  | 品目クラス       | rs_item_class     | VARCHAR |                                                    |
| 23  | 測定単位         | rs_measure_unit   | VARCHAR |                                                    |
