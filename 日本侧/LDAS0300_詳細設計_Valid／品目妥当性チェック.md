...
- 変数.品目クラス = 'M'（ＣＢＵ機種） または 'K'（輸出CKDセット） の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10037
  - エラーメッセージ : 'You cannot specify Product, CBU Model or CKD Model'
    - (商品・ＣＢＵ機種・ＣＫＤ機種品目は指定不可です。)

##### 2.3.2.2. 品目ステータスチェック

- 変数.品目ステータス = '1'（原材料）の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10024
...
- 変数.品目タイプフラグ1 = 'Y' かつ 変数. 品目タイプ ≠ '1'（標準） の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10020
  - エラーメッセージ : 'You can specify only the item of which Item Type is 1(Standard)'
    - (品目ステータス＝１（技術試作）の品目は指定不可です。)

##### 2.3.4.2. 品目タイプフラグ2チェック

- 変数.品目タイプフラグ2 = 'Y' かつ 変数.品目タイプ ≠ '1'（標準） かつ 変数.品目タイプ ≠ '2'（通過）の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10021
...
- 変数.品目クラスフラグ3 = 'Y' かつ 変数.品目クラス ≠ '0'(梱包資材) かつ 変数.品目クラス ≠ '1'（標準） かつ 変数.品目クラス ≠ '2'（通過） の場合、エラーメッセージを出力し処理終了。
...
- 変数.品目クラスフラグ4 = 'Y' かつ 変数.品目クラス ≠ 'E'(製品) かつ 変数.品目クラス ≠ 'F'(輸出CKDセット明細) の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10058
...
- 変数.MRP需要方針コードフラグ5 = 'Y' かつ (変数.MRP需要方針コード < '1'(生産計画品目) または 変数.MRP需要方針コード > '6'(GRP品目)) の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10026
...
- 変数.MRP需要方針コードフラグ6 = 'Y' かつ 変数.MRP需要方針コード ≠ '2'(ハンド管理品目) の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10028
...
- 変数.Wビン管理コードフラグ7 = 'Y' かつ 変数.Wビン管理コード ≠ '0'(管理対象外) の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10029
...
- 変数.Wビン管理コードフラグ8 = 'Y' かつ 変数.Wビン管理コード ≠ '1'(管理対象) の場合、エラーメッセージを出力し処理終了。
  - エラーコード : ld.E.LDP10030
...
- 変数.AIRSサインフラグ9 = 'Y' かつ 変数.AIRSサイン = '1'(AIRS品目) の場合、エラーメッセージを出力し処理終了。
