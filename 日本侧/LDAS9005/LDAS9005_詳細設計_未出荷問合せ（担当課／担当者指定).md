...
担当課、担当者指定のオーダー明細と独立所要量明細の未出荷問合せを返す。
...
| 22  | 生試初品区分     | rs_pilot_class      | VARCHAR |   1:ALL2:生試／単品生試3:初品4:量産                  |
...
| 6  | テーブル   | 日別カレンダーマスター(D)  | le_mst_calendar_sum    | - | ○ | - | - |                         |
