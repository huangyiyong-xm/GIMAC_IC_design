...
| 8   | 生試初品区分     | ps_pilot_class   | VARCHAR | 必須項目：1:ALL2:生試／単品生試3:初品4:量産   |
| 9   | 先行リードタイム | pn_precede_lt    | DECIMAL |                                               |
| 10  | AIRSサイン       | ps_airs_sign         | VARCHAR | 1：含む、2：含まない                      |
...
| 21  | 前工程在庫数     | rn_b_prj_stock_qty  | DECIMAL |                                                    |
| 22  | 引当残数         | rn_alloc_remain_qty | DECIMAL |                                                    |
| 23  | 生試初品区分     | rs_pilot_class      | VARCHAR |                                                    
...
| 6  | テーブル   | 日別カレンダーマスター(D) | le_mst_calendar_sum    | - | ○ | - | - | (旧)lc_mst_calendar_sum |
