...
| ------------ | ------------ | --------------------- |
| IC           | LDAS0320     | Valid／独立所要量削除 |

| RFC | Version | 更新日     | 更新者 | 更新内容 | 確認日     | 確認者 | 承認日     | 承認者 |
| --- | :-----: | ---------- | :----: | -------- | ---------- | :----: | ---------- | :----: |
| -   |  1.0.0  | 2025/09/18 | 余暁東 | 初版作成 | 2025/XX/XX |  XXX  | 2025/XX/XX |  XXX  |

## 1. 処理概要

### 1.1. 機能概要

削除する独立所要量の各項目に対するバリデーションを定義する
...
data_exist_check["<div style='white-space: nowrap;'>2.3.1.独立所要量明細の<br/>対象データ存在チェック</div>"]
data_exist_check
end
...
class arg_process_and_check,init_process,data_exist_check,order_status_check,end_process process
```
...
#### 2.3.1. 独立所要量明細の対象データ存在チェック

独立所要量明細テーブルから対象データの存在をチェックする。
