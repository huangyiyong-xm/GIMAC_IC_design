...
| 2   | SQLコード              | rs_sql_code           | VARVHAR |                                      |
| 3   | エラーコード           | rs_err_code           | VARVHAR |                                      |
| 4   | エラーメッセージ       | rs_err_msg            | VARVHAR |                                      |
| 5   | エラー位置             | rs_err_focus          | VARVHAR |                                      |
| 6   | 部品番号               | rs_itemno             | VARVHAR |                                      |
| 7   | 供給者                 | rs_supplier           | VARVHAR |                                      |
| 8   | 使用者                 | rs_usercd             | VARVHAR |                                      |
| 9   | 品目ステータス         | rs_item_status        | VARVHAR |                                      |
| 10  | 品目名称               | rs_item_name          | VARVHAR |                                      |
| 11  | PYMAC部門コード        | rs_pymac_dept_code    | VARVHAR |                                      |
| 12  | 工程番号               | rs_process_no         | VARVHAR |                                      |
| 13  | 投入作業区             | rs_input_work_center  | VARVHAR |                                      |
| 14  | 納入PF番号             | rs_deliv_pf_no        | VARVHAR |                                      |
| 15  | 出庫数－SIR            | rn_toq_sir            | VARVHAR |                                      |
...
| 27  | 品目クラス             | rs_item_class         | VARVHAR |                                      |
| 28  | 品目分類コード         | rs_reference_key      | VARVHAR |                                      |
| 29  | 組織略称               | rs_org_abbr           | VARVHAR |                                      |
